...
| `docs/overture-tiles-eval.md` | 68 | settled-history · current | A dated tool evaluation for the Tiles surface. | L3 "Evaluated 2026-07-23 for the UI prototype's **Tiles** section". |
| `packages/geoiq/docs/inbox-design.md` | 222 | **split** | Design body → settled-history; its "Open questions" section → live-work. It gates a PR, so its status is live. | L3 "Status: design (spike). Gates PR #10."; L7 "Unverifiable points are listed as **Open questions**, not asserted." |
