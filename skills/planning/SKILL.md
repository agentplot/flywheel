...
- **You leave**: one comment per item — the round's outcome and a pointer to the annotated draft in your session directory. The loop closes items on your evidence; you never close your own.
