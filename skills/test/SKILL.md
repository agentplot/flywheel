...
- **You leave**: the run's result as a comment where your work order says (the bolt's items or unit), and every finding as a NEW queued item on the bolt's milestone — findings are items, never in-place fixes.
